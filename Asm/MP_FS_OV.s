...
; Uses my "Oversampling" mode (faster !)
...
MP_NB_BUFFERS	equ 4
MP_MODE 	equ 3	; Oversampling Volume. Oversampling modes only are managed here (2 or 3)
...
my_vbl:
	...
	ifeq MP_MODE-2
; Oversampling No Volume
nb_mixs_per_line	equ OVERSCAN_NOPS_AFTER_LEFT_BORDER/MP_NOPS_MIX_OVS_MIX
...
my_timA:
	...
	nops OVERSCAN_NOPS_AFTER_LEFT_BORDER-MP_NOPS_MIX_OVS_INIT
	mp_mix_ovs_init_m
	...
	overscan_left_border
	nops OVERSCAN_NOPS_AFTER_LEFT_BORDER-(nb_mixs_per_line)*MP_NOPS_MIX_OVS_MIX
	mp_mix_ovs_mix_m nb_mixs_per_line
	overscan_right_border
	ENDR
	...
	nops OVERSCAN_NOPS_BEFORE_LEFT_BORDER
	overscan_left_border
	nops OVERSCAN_NOPS_AFTER_LEFT_BORDER-(nb_mixs_missing)*MP_NOPS_MIX_OVS_MIX
	mp_mix_ovs_mix_m nb_mixs_missing
	overscan_right_border

	; Now end the mix process
	nops OVERSCAN_NOPS_BEFORE_LEFT_BORDER
	overscan_left_border
	nops OVERSCAN_NOPS_AFTER_LEFT_BORDER-MP_NOPS_MIX_OVS_END-4
	mp_mix_ovs_end_m
	move.w #$000,(HW_ST_PAL_ADR).w
	overscan_right_border
...
.exit	timer_eos "A"
	...
	ifeq MP_MODE-3
; Oversampling With Volume
nb_mixs_per_line	equ OVERSCAN_NOPS_AFTER_LEFT_BORDER/MP_NOPS_MIX_OVS_VOL_MIX
nb_lines_for_mix	equ MP_BUFF_SLICE/nb_mixs_per_line
nb_mixs_missing		equ MP_BUFF_SLICE-(nb_lines_for_mix*nb_mixs_per_line)
...
my_timA:
	...
	move.w #$007,(HW_ST_PAL_ADR).w
	overscan_left_border
	nops OVERSCAN_NOPS_AFTER_LEFT_BORDER-MP_NOPS_MIX_OVS_VOL_INIT
	...
	nops OVERSCAN_NOPS_BEFORE_LEFT_BORDER
	overscan_left_border
	nops OVERSCAN_NOPS_AFTER_LEFT_BORDER-(nb_mixs_per_line)*MP_NOPS_MIX_OVS_VOL_MIX
	mp_mix_ovs_vol_mix_m nb_mixs_per_line
	overscan_right_border
	ENDR
	...
	nops OVERSCAN_NOPS_BEFORE_LEFT_BORDER
	overscan_left_border
	nops OVERSCAN_NOPS_AFTER_LEFT_BORDER-(nb_mixs_missing)*MP_NOPS_MIX_OVS_VOL_MIX
	mp_mix_ovs_vol_mix_m nb_mixs_missing
	overscan_right_border

	; Now end the mix process
	nops OVERSCAN_NOPS_BEFORE_LEFT_BORDER
	overscan_left_border
	nops OVERSCAN_NOPS_AFTER_LEFT_BORDER-MP_NOPS_MIX_OVS_VOL_END-4
