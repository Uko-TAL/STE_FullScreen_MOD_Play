...
MP_NB_BUFFERS	equ 4
MP_MODE 	equ 1	; Classical Volume. Classical modes only are managed here (0 or 1)
...
my_vbl:
	...
	ifeq MP_MODE
; Classical No Volume
nb_mixs_per_line	equ OVERSCAN_NOPS_AFTER_LEFT_BORDER/MP_NOPS_MIX_STD_MIX
nb_lines_for_mix	equ MP_BUFF_SLICE/nb_mixs_per_line
nb_mixs_missing		equ MP_BUFF_SLICE-(nb_lines_for_mix*nb_mixs_per_line)
...
my_timA:
	...
	nops OVERSCAN_NOPS_AFTER_LEFT_BORDER-MP_NOPS_MIX_STD_INIT_LEFT
	mp_mix_std_init_left_m
	...
	overscan_left_border
	nops OVERSCAN_NOPS_AFTER_LEFT_BORDER-(nb_mixs_per_line)*MP_NOPS_MIX_STD_MIX
	mp_mix_std_mix_m nb_mixs_per_line
	overscan_right_border
	ENDR
	...
	nops OVERSCAN_NOPS_BEFORE_LEFT_BORDER
	overscan_left_border
	nops OVERSCAN_NOPS_AFTER_LEFT_BORDER-(nb_mixs_missing)*MP_NOPS_MIX_STD_MIX
	mp_mix_std_mix_m nb_mixs_missing
	overscan_right_border

	; Now initialise the mix process for the right channel
	nops OVERSCAN_NOPS_BEFORE_LEFT_BORDER
	overscan_left_border
	nops OVERSCAN_NOPS_AFTER_LEFT_BORDER-MP_NOPS_MIX_STD_INIT_RIGHT
	...
	nops OVERSCAN_NOPS_BEFORE_LEFT_BORDER
	overscan_left_border
	nops OVERSCAN_NOPS_AFTER_LEFT_BORDER-MP_NOPS_MIX_STD_END-4
	mp_mix_std_end_m
	move.w #$000,(HW_ST_PAL_ADR).w
	overscan_right_border
...
.exit	timer_eos "A"
	...
	ifeq MP_MODE-1
; Classical With Volume
nb_mixs_per_line	equ OVERSCAN_NOPS_AFTER_LEFT_BORDER/MP_NOPS_MIX_STD_VOL_MIX
nb_lines_for_mix	equ MP_BUFF_SLICE/nb_mixs_per_line
nb_mixs_missing		equ MP_BUFF_SLICE-(nb_lines_for_mix*nb_mixs_per_line)
...
my_timA:
	...
	move.w #$007,(HW_ST_PAL_ADR).w
	overscan_left_border
	nops OVERSCAN_NOPS_AFTER_LEFT_BORDER-MP_NOPS_MIX_STD_VOL_INIT_LEFT
	mp_mix_std_vol_init_left_m
	overscan_right_border	
	...
	nops OVERSCAN_NOPS_BEFORE_LEFT_BORDER
	overscan_left_border
	nops OVERSCAN_NOPS_AFTER_LEFT_BORDER-(nb_mixs_per_line)*MP_NOPS_MIX_STD_VOL_MIX
	mp_mix_std_vol_mix_m nb_mixs_per_line
	overscan_right_border
	ENDR
	...
	nops OVERSCAN_NOPS_BEFORE_LEFT_BORDER
	overscan_left_border
	nops OVERSCAN_NOPS_AFTER_LEFT_BORDER-(nb_mixs_missing)*MP_NOPS_MIX_STD_VOL_MIX
	mp_mix_std_vol_mix_m nb_mixs_missing
	overscan_right_border

	; Now initialise the mix process for the right channel
	nops OVERSCAN_NOPS_BEFORE_LEFT_BORDER
	overscan_left_border
	nops OVERSCAN_NOPS_AFTER_LEFT_BORDER-MP_NOPS_MIX_STD_VOL_INIT_RIGHT
	...
	nops OVERSCAN_NOPS_BEFORE_LEFT_BORDER
	overscan_left_border
	nops OVERSCAN_NOPS_AFTER_LEFT_BORDER-MP_NOPS_MIX_STD_VOL_END-4
...
; Here is the max value for the 3 sample mods (get for Illusion)
mp_buffer	ds.l ($2BD14+4)/4
mp_buffer_end
